from PyQt6.QtWidgets import QMainWindow,QApplication,QWidget,QVBoxLayout,QRadioButton,QHBoxLayout,QGroupBox,QFormLayout,QLabel,QLineEdit,QScrollArea,QPushButton
...
class CentralLimitTheorem(QMainWindow):
    ...
    def Solution(self,value:int,turns:int,mainVLay:QVBoxLayout,but:QPushButton):
        ...
        self.ProduceMap(samplesAr,value,turns,mainVLay,but)

    def ProduceMap(self,samplesAr:ty.List[ty.Tuple[int,ty.List[int]]],value:int,turns:int,mainVLay:QVBoxLayout,but:QPushButton):
        avgOfSamples = []
